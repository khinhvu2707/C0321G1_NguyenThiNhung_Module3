...
<form method="post">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td> Tên sản phẩm : </td>
                <td><input type="text" name="ten" id="ten" value="${requestScope["product"].getTenSanPham()}"></td>
            </tr>
            <tr>
                <td> Giá sản phẩm : </td>
            ...
            <tr>
                <td> Hãng sản xuất : </td>
                <td><input type="text" name="nhaSX" id="nhaSX" value="${requestScope["product"].getNhaSanXuat()}"></td>
            </tr>
            <tr>
                <td></td>
