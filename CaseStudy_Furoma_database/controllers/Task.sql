...
where dv.id_dich_vu  in (select hop_dong.id_dich_vu from hop_dong where hop_dong.ngay_lam_hop_dong > 2019-03-23 );
...
from dich_vu dv
inner join loai_dich_vu ldv on dv.id_loai_dich_vu = ldv.id_loai_dich_vu
where dv.id_dich_vu in (select dv.id_dich_vu from hop_dong where hop_dong.ngay_lam_hop_dong > 2018-01-01 or hop_dong.ngay_lam_hop_dong < 2019-01-01) ;
